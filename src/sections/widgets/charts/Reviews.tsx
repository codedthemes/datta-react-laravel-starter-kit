    ...
    <MainCard title="Reviews">
      <Row>
        <Col sm={6} className="text-center m-b-20">
          ...
          <ReactApexChart options={chartOptions} series={chartOptions.series} type="donut" height={110} />
        ...
        <Col sm={6} className="text-center m-b-20">
          ...
          <ReactApexChart options={chartOptions1} series={chartOptions1.series} type="donut" height={110} />
