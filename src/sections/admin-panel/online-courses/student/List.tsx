    ...
    <MainCard
      ...
      secondary={
        <Stack direction="horizontal" gap={2}>
          <Link to="/admin-panel/online-course/student/apply" className="btn btn-outline-secondary">
            Apply Student List
          </Link>
          <Link to="/admin-panel/online-course/student/add" className="btn btn-primary">
            Add Student
          </Link>
        </Stack>
      }
        ...
        cell: () => (
          <Stack direction="horizontal" gap={1}>
            <OverlayTrigger placement="bottom" overlay={<Tooltip>View</Tooltip>}>
              <a href="#" className="avatar avatar-xs mx-1 btn-link-secondary">
