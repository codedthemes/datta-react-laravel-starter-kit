        ...
        <Col xl={6}>
          <div className="border rounded p-3 h-100">
            <Stack direction="horizontal" className="align-items-center justify-content-between mb-2">
              ...
              <Button variant="light-secondary" size="sm" onClick={handleShow} aria-expanded={open}>
              ...
              <Modal size="lg" show={show} onHide={handleClose}>
                <Modal.Header className="justify-content-between">
                  ...
                  <Stack direction="horizontal" className="align-items-center justify-content-end">
                    <Button variant="link-secndary" className="avatar avatr-s" onClick={() => setOpen(!open)}>
        ...
        <Col xl={6}>
          <div className="border rounded p-3 h-100">
            <Stack direction="horizontal" className="align-items-center justify-content-between mb-2">
              ...
              <Button variant="light-secondary" className="btn-sm" onClick={handleShow}>
