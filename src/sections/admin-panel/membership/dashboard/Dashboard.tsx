            ...
            <Carousel prevIcon={false}>
              {carouselData.map((carouselItem, index) => (
                <Carousel.Item key={index}>
                  <Stack direction="horizontal" gap={2} className="align-items-center justify-content-end my-1">
                    <Button variant="light-secondary" size="sm">
                      <i className="ti ti-arrow-left f-16 hover:text-secondary" />
                    </Button>

                    <Button variant="light-secondary" size="sm">
                      <i className="ti ti-arrow-right f-16 hover:text-secondary" />
                    </Button>
                  </Stack>
                  <p>
                    {carouselItem.date} <Badge className="text-bg-primary">TODAY</Badge>
                  </p>
                  {carouselItem.items.map((cardItem, cardIndex) => (
            ...
            <Col md={6}>
              <div className="rounded border p-3 mb-2">
                <span className="d-block">
                  <i className="fas fa-circle text-primary f-10 m-r-10" />
                  New Membership
                </span>
              </div>
              <div className="rounded border p-3">
                <span className="d-block">
                  <i className="fas fa-circle text-primary text-opacity-25 f-10 m-r-10" />
                  Repeat Membership
                </span>
              </div>
            </Col>
