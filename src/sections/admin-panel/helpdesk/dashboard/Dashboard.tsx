  ...
  return (
    <Row>
      {data.map((item, index) => {
        ...
        return (
          <Col key={index} xl={4} md={6}>
            <MainCard className="support-bar" bodyClassName="p-0 pb-0">
              <div className="p-4">
              ...
              <div className={`${item.bgColor} ${item.textColor} p-4`}>
      ...
      <Col xl={5} md={6}>
        ...
        >
          <div className="simplebar hei-400">
            {feeds.map((feed) => (
              <Row key={feed.id} className="align-items-center m-b-30">
                <Col xs="auto" className="p-r-0">
                  <i className={`ti ${feed.icon} ${feed.bgColor} feed-icon text-${feed.textColor}`} />
                </Col>
                <Col>
                  <Link to={feed.link}>
                    <h6 className="mb-0">
        ...
        <MainCard bodyClassName="p-t-0 p-b-0">
          <Row>
            <Col xs={4} className="bg-primary border-feed">
              <i className="ti ti-book d-block f-46" />
            </Col>
            <Col xs={8}>
