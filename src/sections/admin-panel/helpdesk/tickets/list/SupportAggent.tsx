...
import Avatar4 from 'assets/images/user/avatar-5.jpg';

// =============================|| TICKET - SUPPORT AGGENT ||============================== //

export default function SupportAggent() {
  return (
    <MainCard title="Support Aggent" bodyClassName="p-0">
