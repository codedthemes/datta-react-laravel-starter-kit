...
export default function Methods() {
  ...
  return (
    <MainCard title="Methods" subheader="Methods can be used to control a switch button directly.">
      <BootstrapSwitchButton onlabel="On" offlabel="Off" checked={isChecked} onChange={() => setIsChecked(!isChecked)} />
