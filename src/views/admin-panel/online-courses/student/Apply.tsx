...
function ReactTable({ columns, data }: ReactTableProps) {
  ...
  return (
    <MainCard bodyClassName="p-0" title="Apply Student list">
      ...
      },
      {
        ...
        cell: () => (
          <Stack direction="horizontal" gap={1}>
            <Button variant="light-success" className="avatar avatar-xs">
              <i className="ti ti-check f-20" />
            </Button>
            <Button variant="light-danger" className="avatar avatar-xs">
              <i className="ti ti-x f-20" />
            </Button>
            <Button variant="light-secondary" className="avatar avatar-xs">
