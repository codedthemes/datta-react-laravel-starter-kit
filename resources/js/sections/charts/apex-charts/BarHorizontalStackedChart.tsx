...
export default function BarHorizontalStackedChart() {
  ...
  const [options, setOptions] = useState<ChartProps>(barHorizontalStckedChartOptions);

  useEffect(() => {
    setOptions({
      ...barHorizontalStckedChartOptions,
      chart: { ...barHorizontalStckedChartOptions.chart, fontFamily: fontFamily },
  ...
  }, [resolvedTheme, fontFamily, primaryMain, successMain, warningMain, infoMain, indigoMain]);
