    ...
    <MainCard
      ...
      secondary={
        <Stack direction="horizontal" gap={2}>
          <a href="/admin-panel/online-course/student/apply" className="btn btn-outline-secondary">
            Apply Student List
          </a>
          <a href="/admin-panel/online-course/student/add" className="btn btn-primary">
            Add Student
          </a>
        </Stack>
      }
