...
const stats = [
  ...
  { value: '4.1K', label: 'Followers' },
  { value: '823', label: 'Following' }
];
      ...
      <MainCard
        ...
        title={
          <div className="cover-img-block">
            <Image src={slider7} alt="profile cover background" fluid />
          </div>
        }
      >
          ...
          <Row className="align-items-end justify-content-between">
            ...
            <Col xs="auto">
              <div className="position-relative d-inline-block">
                <Image className="wid-80" roundedCircle fluid src={avatar3} alt="User" />
        ...
        <div className="text-center">
          ...
          <p className="mb-0">Passionate about creating intuitive digital experiences</p>
        </div>
